...
const services = [
  ...
  },
  {
    ...
    location: "Main Sanctuary",
    description: "A more intimate gathering focused on deep worship and Bible study."
  },
  {
    id: 3,
    ...
    description: "A midweek spiritual refreshment with focused prayer and short teaching."
  },
  {
    id: 4,
    ...
    location: "Youth Hall",
    description: "For teenagers and young adults with worship, games, and relevant teaching."
  }
];
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="space-y-4">
                <h3 className="text-xl font-medium text-faith-900">{service.name}</h3>
