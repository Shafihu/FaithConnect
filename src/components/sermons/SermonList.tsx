...
const sermonData = [
  {
    ...
    date: "July 16, 2023",
    description:
      "In this powerful message, Pastor Michael explores how we can find true peace even in the midst of life's most challenging circumstances.",
  ...
  },
  {
    ...
    date: "July 9, 2023",
    description:
      "Discover how practicing gratitude can transform your perspective and deepen your relationship with God.",
  ...
  },
  {
    ...
    date: "July 2, 2023",
    description:
      "Learn biblical principles for nurturing healthy family relationships and creating a Christ-centered home.",
...
const seriesData = [
  {
    ...
    title: "Faith Journey",
    description:
      "A 5-part series exploring what it means to live by faith in today's world.",
  ...
  },
  {
    ...
    description:
      "Discovering the transformative power of God's grace in every aspect of our lives.",
  ...
  },
  {
    ...
    title: "Prayer Power",
    description:
      "Learning how to develop a dynamic prayer life that connects with God's heart.",
  ...
  },
  {
    ...
    description:
      "Biblical wisdom for building strong families and godly relationships.",
...
export default function SermonList({
  ...
  const filteredSermons = sermonData.filter((sermon) => {
    const matchesFilter =
      filter === "all" || sermon.topics.includes(filter.toLowerCase());
    const matchesSearch =
      searchQuery === "" ||
  ...
  const displaySermons = [...filteredSermons];
  if (type === "popular") {
        ...
        {filteredSeries.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-faith-600">
              No sermon series found matching your criteria.
            </p>
          </div>
        ) : (
