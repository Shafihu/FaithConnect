...
const leadership = [
  ...
  },
  {
    name: "Benjamin Adu",
    role: "Youth Pastor",
    bio: "Benjamin has a special gift for connecting with and mentoring our youth.",
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/80 mb-6 animate-fade-in animate-delay-200">
              FaithConnect is a welcoming community of believers dedicated to
              sharing God's love and growing together in faith.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-faith-700 pl-4">
                  <h3 className="text-xl font-medium mb-2 text-faith-900">
                    Our Mission
                  </h3>
                  <p className="text-faith-600">
                    To connect people to Jesus Christ and to one another through
                    worship, discipleship, fellowship, ministry, and mission.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-faith-700 pl-4">
                  ...
                  <p className="text-faith-600">
                    To be a vibrant community of faith that transforms lives,
                    renews the city, and impacts the world with the love and
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="md:text-right md:pr-8">
                    ...
                    <p className="text-faith-600">
                      Founded by a small group of 20 families with a vision to
                      establish a church focused on Biblical teaching and
                      community outreach.
                    </p>
                  </div>
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="md:order-2 md:text-left md:pl-8">
                    <h3 className="text-xl font-medium text-faith-900 mb-2">
                      1990: Growing Together
                    </h3>
                    <p className="text-faith-600">
                      The congregation grew to over 200 members, and we moved to
                      our current location to accommodate our expanding
                      ministries.
                    </p>
                  </div>
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="md:text-right md:pr-8">
                    ...
                    <p className="text-faith-600">
                      Pastor Michael Johnson became our senior pastor, bringing
                      fresh vision and launching our youth and community
                      outreach programs.
                    </p>
                  </div>
                  <div className="md:pl-8">
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="md:order-2 md:text-left md:pl-8">
                    ...
                    <p className="text-faith-600">
                      With over 500 members, we continue to grow and adapt to
                      meet the spiritual needs of our community while staying
                      true to our founding vision.
                    </p>
                  </div>
                  <div className="md:order-1 md:pr-8">
                    <div className="rounded-lg overflow-hidden shadow-md">
            ...
            {leadership.map((leader, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-faith-600 text-sm mb-3">{leader.role}</p>
                  <p className="text-faith-700">{leader.bio}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-faith-600 mb-0">
                  We believe that everyone has gifts and talents that can be
                  used to serve God and others. There are many ways to get
                  involved at FaithConnect.
                </p>
              </div>
              <div className="flex-shrink-0">
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center bg-faith-700/20 rounded-full px-4 py-1.5 mb-4">
              ...
              <span className="text-sm font-medium text-faith-300">
                Our Beliefs
              </span>
            </div>
            ...
            <p className="text-white/80 max-w-2xl mx-auto">
              ...
              Our faith informs our commitment to love and serve our community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/80">
                ...
                sinless life, miracles, atoning death, bodily resurrection, and
                ascension.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
              ...
              <p className="text-white/80">
                We believe Christians are called to live holy lives, loving God
